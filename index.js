...
function filterFundedOnly() {
  ...
  const passedGoalGames = GAMES_JSON.filter((game) => game.pledged > game.goal);
  // use the function we previously created to add unfunded games to the DOM
  addGamesToPage(passedGoalGames);
}
...
const unfundedGamesString =
  totalUnfundedGames === 0
    ...
    : `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${totalUnfundedGames} games remain unfunded. We need your
